...
// setters
	...
	public void setAll(String nameIn, int capacityIn, LocalDate dateIn, double priceIn, String GymWorkerIn, Inventory inventoryIn){
		setName(nameIn);
		setCapacity(capacityIn);
		setDate(dateIn);
		setPrice(priceIn);
		setGymWorker(GymWorkerIn);
		setInventory(inventoryIn);
	}
